...
class CleverCreator:
    ...
    def generateAcademicSessions(self):
        ...
        # Explicitly tell Pandas that these two columns are of type datetime.
        # This is to make sure that the date string conversion actually works.
        sdsAcademicSessions['startDate'] = pandas.to_datetime(sdsAcademicSessions['startDate'])
        sdsAcademicSessions['endDate'] = pandas.to_datetime(sdsAcademicSessions['endDate'])
